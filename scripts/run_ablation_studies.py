...
python scripts/run_ablation_studies.py feature-combos --n-components 20 --targets clicks epc

Outputs
-------
Writes CSV results under: opt_results/analysis/ablations/
"""
...
def fit_glm_candidate_mse(
    *,
    ...
    param_grid = {"model__alpha": [0.0, 0.01, 0.1, 0.5, 1.0, 2.0, 5.0]}
...
def main() -> None:
    ...
    def add_common(p: argparse.ArgumentParser) -> None:
        ...
        p.add_argument(
            ...
            nargs="+",
            default=["clicks", "epc"],
            help="Targets to evaluate: conversion clicks epc",
        )
        ...
        p.add_argument(
            "--results-dir",
            type=str,
            default=str((_REPO_ROOT / "opt_results" / "analysis" / "ablations").as_posix()),
